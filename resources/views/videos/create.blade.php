            ...
            <form action="{{route('videos.store')}}" method="POST"  enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    {{--<div class="col-md-6">
                        ...
                        <input name="thumbnail" type="text" class="form-control" value="{{old("thumbnail")}}" placeholder="تصویر بند انگشتی">
                    </div>--}}
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <label>توضیحات</label>
                        <textarea name="description" class="form-control" rows="4" value="{{old("description")}}"  placeholder="توضیح"></textarea>
                    </div>
